...
from ..service.recipes_service import get_user_cooked_recipes, get_recipes_by_recipes_id, get_ingredients_collections_by_recipes
...
def get_user_cooked_recipes_by_page(user_id: str, page_num: int = 0):
    ...
    ingredients_collection = get_ingredients_collections_by_recipes(recipes)
